...
export const JuniorResetLinkSent = "Palautuslinkki lähetetty."
export const JuniorResetLinkThrottled = "Palautuslinkkejä pyydetty liikaa"
...
export const EmailServiceNotAvailable = "Sähköpostipalvelu ei ole käytettävissä."
export const EmailAnnouncementSent = "Sähköpostitiedote lähetetty"
export const SmsBatchSent = "Tekstiviestitiedote lähetetty"
export const SmsServiceNotAvailable = "Tekstiviestipalvelu ei ole käytettävissä."
export const SMSNotAvailableButUserCreated = "Tekstiviestipalvelu ei ole käytettävissä, mutta käyttäjä luotiin."
