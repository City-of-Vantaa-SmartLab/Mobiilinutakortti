...
export const ExtraEntryNotFound = "Poistettavaa lisämerkintää ei löytynyt."
...
export const EmailBatchSent = "Sähköpostierän lähettäminen onnistui."
export const SmsBatchSent = "Tekstiviestierän lähettäminen onnistui."
