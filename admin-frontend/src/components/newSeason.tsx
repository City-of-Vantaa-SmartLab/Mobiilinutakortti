...
const NewSeasonModal = ({ onConfirm, onCancel, loadingState }: NewSeasonModalProps) => {
...
const NewSeason = () => {
    ...
    return (
        <Card sx={{ marginTop: 2 }}>
            ...
            <CardContent>
                <p>
                    Uuden kauden aloittaminen muuttaa nuorten tilaksi "{expiredStatusName}"
                    ja lähettää kaikille huoltajille tekstiviestinä linkin kortin uusintahakemukseen.
                </p>
                {showExtraEntries && <p>
                    Tämä toiminto ei vaikuta nuoriin, joiden tila on "{extraEntriesOnlyStatusName}".
                </p>}
                <p>
