...
export const translations: Translations = {
  addToHomescreen: (
    <>
      Klikkaa <i />
      -kuvaketta ja valitse ”Lisää Koti-valikkoon” lisätäksesi sovelluksen
    </>
  ),
  login: {
    title: "Nutakortti",
    ...
    authMessages: {
      authFail:
        "Kirjautuminen epäonnistui. Syötä puhelinnumerosi saadaksesi uuden kirjautumislinkin",
      linkRequestSuccess: "Uusi linkki lähetettiin syöttämääsi numeroon",
      linkRequestFail:
        "Linkin lähetys epäonnistui, ole hyvä ja yritä uudelleen",
    },
  },
  logout: {
  ...
  parentRedirect: {
    ...
    ingress:
      "Nutakortti on maksuton mobiililaitteella toimiva Vantaan nuorisotilojen jäsenkortti, jonka avulla nuori kirjautuu sisään nuorisotilaan.",
    description: (
      <p>
        Tällä lomakkeella voit huoltajana hakea lapsellesi tai nuorellesi
        Vantaan kaupungin nuorisopalveluiden jäsenkorttia. Nutakortti uusitaan
        toimintakausittain saman lomakkeen kautta. Kirjaudu sisään
        pankkitunnuksilla, mobiilivarmenteella tai sirullisella henkilökortilla
        ja täytä pyydetyt tiedot.
        <br />
        <br />
        ...
        <br />
        <br />
        Käsittelemme hakemuksia jatkuvasti, mutta ruuhka-aikana käsittelyssä
        saattaa olla viivettä. Nuorisotilalla voi kuitenkin käydä heti
  ...
  parentRegistration: {
    ...
    form: {
      ...
      photoPermissionDescription:
        "Valokuvaamme ja videoimme ajoittain toimintaamme ja nuoria viestintää varten. Kuvia voidaan käyttää Nuorisopalveluiden julkaisuissa (esim. sosiaalisessa mediassa, nettisivuilla ja esitteissä). \nLapseni kuvaa saa käyttää lapsen asuinkaupungin viestinnässä.",
      ...
      youthClubDescription:
        "Valitse nuorisotila, jossa lapsesi tai nuoresi yleensä käy.",

      communicationsLanguage: "Kommunikaatiokieli",
      communicationsLanguageDefault: "Valitse kieli",
      communicationsLanguageDescription:
        "Kieli, jota järjestelmä käytettää viestinnässä nuoren kanssa (esim. tekstiviestit)",
      ...
      termsOfUse: (
        <>
          ...
          <a
            ...
            href="https://www.vantaa.fi/sites/default/files/document/Mobiilinutakortin%20k%C3%A4ytt%C3%B6ehdot%202022pdf.pdf"
          >
            käyttöehdot
          </a>
        </>
    ...
    confirmation: {
      ...
      message: (logoutLink, startOverLink) => (
        <p>
          Kun nuoren jäsenkorttihakemus on käsitelty, hänelle lähetetään
          tekstiviestillä henkilökohtainen kirjautumislinkki palveluun.
          <br />
          <br />
          Käsittelemme hakemuksia jatkuvasti, mutta ruuhka-aikana käsittelyssä
          saattaa olla viivettä. Nuorisotilalla voi kuitenkin käydä heti
          ...
          <br />
          <br />
          Voit nyt {logoutLink("kirjautua ulos")} tai{" "}
          {startOverLink("aloittaa alusta")} rekisteröidäksesi nutakortin
          toiselle lapselle.
        </p>
      ),
    },
    error: {
      message:
        "Jokin meni pieleen. Jos virhe toistuu useasti, ole yhteydessä lähinuorisotilaasi tai Mobiilinutakortin yhteyshenkilöön p. +358 400 662739 (virka-aikana).",
      back: "Takaisin",
    },
  },
  qrPage: {
    codeExpired: "Kausi vanhentunut",
    codeValid: "Kausi voimassa",
    login: "Kirjaudu",
