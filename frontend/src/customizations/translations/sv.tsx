...
export const translations: Translations = {
  addToHomescreen: (
    <>
      Klicka på ikonen <i /> och välj ”Lägg till på startskärmen” för att lägga
      till appen
    </>
  ),
  login: {
    ...
    authMessages: {
      authFail:
        "Inloggningen misslyckades. Ange ditt telefonnummer för att få en ny inloggningslänk",
  ...
  parentRedirect: {
    ...
    ingress:
      "Nutakortet är ett gratis medlemskort för Vanda ungdomsklubbar som fungerar i mobila enheter. Din ungdom använder det för att logga in på ungdomsklubben.",
    description: (
      <p>
        Med det här formuläret kan du ansöka om ett medlemskort för
        ungdomstjänsten i Vanda stads medlem för din ungdom. Kortet förnyas med
        samma formulär för varje aktivitetstermin. Logga in med nätbankskoder,
        mobilcertifikat eller identitetskort och fyll i den begärda
        informationen.
        <br />
        <br />
        När ansökan har kommit in ringer vi dig och skickar undomen en personlig
        inloggningslänk till tjänsten via SMS.
      </p>
    ),
  ...
  parentRegistration: {
    ...
    form: {
      ...
      photoPermissionDescription:
        "Vi fotograferar och filmar vår verksamhet då och då för offentlig kommunikation. Bilder kan användas i ungdomstjänstens publikationer (t.ex. i sociala medier, webbsidor och broschyrer).\n" +
      ...
      communicationsLanguageDescription:
        "Språk som systemet använder för meddelanden som skickas till ungdomen (t.ex. SMS-meddelanden)",
    ...
    confirmation: {
      ...
      message: (logoutLink, startOverLink) => (
        <p>
          När ungdomens medlemskortsansökan har behandlats får han eller hon en
          personlig inloggningslänk via sms. Du kan nu {logoutLink("logga ut")}{" "}
          eller {startOverLink("börja om")} för att ansöka om kort för en annan
          ungdom.
        </p>
      ),
    },
    error: {
      message:
        "Något gick fel. Om felet återkommer ofta, kontakta din närmaste ungdomsklubb eller Nutakortets kontaktperson, tel. +358 400 662739 (mån-fre 8-16).",
      back: "Tillbaka",
    },
  },
  qrPage: {
