...
export const translations: Translations = {
  ...
  parentRegistration: {
    ...
    form: {
      ...
      termsOfUse: (
        <>
          Jag godkänner till behandling av uppgifter i samband med Nutakortti-tjänsten och accepterar&nbsp;<a target='_blank' rel="noopener noreferrer" href='https://www.vantaa.fi/sites/default/files/document/Mobiilinutakortin%20k%C3%A4ytt%C3%B6ehdot.pdf'>användarvillkoren</a>.
        </>
      ),
    ...
    error: {
      ...
      alternativeMessage: (<>Något gick fel. Om felet återkommer ofta, kontakta din <a target='_blank' rel="noopener noreferrer" href='https://www.vantaa.fi/fi/palveluhakemisto/palvelu/nuorisotilatoiminta#tab-units'>närmaste ungdomsklubb</a>.</>),
      back: 'Tillbaka',
    }
  },
  qrPage: {
